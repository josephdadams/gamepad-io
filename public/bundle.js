;(function () {
...
})()(
    {
            ...
            function (require, module, exports) {
                        ...
                        gamepads.length < 1
                            ...
                            : gamepads.map((gamepad, idx) =>
                                  x('.gamepad')(
                                      ...
                                      title('Axes'),
                                      x('.axes')(
                                          axes(gamepad.index, gamepad.axes)
                                      )
                                  )
                              )
                    )
                ...
                function axes(index, arr) {
                    return arr.map((axis, idx) => {
                        var pressed =
                            axis < -0.15 || axis > 0.15 ? '.pressed' : ''
                        var pressedBool =
                            axis < -0.15 || axis > 0.15 ? true : false
                ...
                function store(state, emitter) {
                    ...
                    // Set up socket event listener for 'gamepad_connected'
                    socket.on('gamepad_connected', (data) => {
                        console.log('Gamepad connected:', data) // Replace with your desired logic
                        // Example: Add gamepad data to state
                        state.controllers[data.index] = data
                        emitter.emit('render')
                    })

                    // Set up socket event listener for 'gamepad_disconnected'
                    socket.on('gamepad_disconnected', (data) => {
                        console.log('Gamepad disconnected:', data) // Replace with your desired logic
                        // Example: Remove gamepad data from state
        ...
        9: [
                    ...
                    function h() {
                        ...
                        function item(l) {
                            ...
                            if (l == null);
                                ...
                                e.appendChild(
                                    (r = document.createTextNode(l.toString()))
                                )
                            }
            ...
            { 'browser-split': 3, 'class-list': 4, 'html-element': 2 },
        ],
        10: [
            function (require, module, exports) {
                var indexOf = [].indexOf
        ...
        12: [
            function (require, module, exports) {
                ...
                Nanobus.prototype.emit = function (eventName) {
                    ...
                    var emitTiming = nanotiming(
                        this._name + "('" + eventName.toString() + "')"
                    )
                ...
                Nanobus.prototype.on = Nanobus.prototype.addListener =
                    function (eventName, listener) {
                        ...
                        assert.equal(
                            typeof listener,
                            'function',
                            'nanobus.on: listener should be type function'
                        )
                ...
                Nanobus.prototype.prependListener = function (
                    eventName,
                    listener
                ) {
                    assert.ok(
                    ...
                    assert.equal(
                        typeof listener,
                        'function',
                        'nanobus.prependListener: listener should be type function'
                    )
                ...
                Nanobus.prototype.once = function (eventName, listener) {
                    ...
                    assert.equal(
                        typeof listener,
                        'function',
                        'nanobus.once: listener should be type function'
                    )
                ...
                Nanobus.prototype.prependOnceListener = function (
                    eventName,
                    listener
                ) {
                    assert.ok(
                    ...
                    assert.equal(
                        typeof listener,
                        'function',
                        'nanobus.prependOnceListener: listener should be type function'
                    )
                ...
                Nanobus.prototype.removeListener = function (
                    eventName,
                    listener
                ) {
                    assert.ok(
                    ...
                    assert.equal(
                        typeof listener,
                        'function',
                        'nanobus.removeListener: listener should be type function'
                    )
                ...
                Nanobus.prototype._emit = function (
                    arr,
                    eventName,
                    data,
                    uuid
            ...
            { assert: 11, nanotiming: 19, 'remove-array-items': 20 },
        ],
        13: [
            function (require, module, exports) {
                ...
                Choo.prototype.view = function (handler) {
                    assert.equal(
                        typeof handler,
                        'function',
                        'choo.view: handler should be type function'
                    )
                ...
                Choo.prototype.use = function (cb) {
                    assert.equal(
                        typeof cb,
                        'function',
                        'choo.use: cb should be type function'
                    )
                    var self = this
                ...
                Choo.prototype.start = function () {
                    ...
                    assert.equal(
                        typeof this._viewHandler,
                        'function',
                        'choo.start: view handler was not found. try calling choo.view'
                    )
                    ...
                    assert.ok(
                        this._tree,
                        'choo.start: no valid DOM node returned'
                    )
                    ...
                    this.emitter.prependListener(
                        ...
                        nanoraf(function () {
                            ...
                            assert.ok(
                                newTree,
                                'choo.render: no valid DOM node returned'
                            )
                ...
                Choo.prototype.mount = function mount(selector) {
                    ...
                    documentReady(function () {
                        ...
                        assert.ok(
                            self._tree,
                            'choo.mount: could not query selector: ' + selector
                        )
                        assert.equal(
                            self._tree.nodeName,
                            newTree.nodeName,
            ...
            { assert: 11, nanobus: 12, nanomorph: 14, nanoraf: 17 },
        ],
        14: [
            function (require, module, exports) {
                ...
                function nanomorph(oldTree, newTree, options) {
                    ...
                    assert.equal(
                        typeof oldTree,
                        'object',
                        'nanomorph: oldTree should be an object'
                    )
                    assert.equal(
                        typeof newTree,
                        'object',
                        'nanomorph: newTree should be an object'
                    )
                ...
                function getComponentId(node) {
                    return node.dataset
                        ? node.dataset.nanomorphComponentId
                        : undefined
                }
                    ...
                    for (var j = oldAttrs.length - 1; j >= 0; --j) {
                        ...
                        if (attr.specified !== false) {
                            ...
                            if (attrNamespaceURI) {
                                attrName = attr.localName || attrName
                                if (
                                    !newNode.hasAttributeNS(
                                        attrNamespaceURI,
                                        attrName
                                    )
                                ) {
                                    oldNode.removeAttributeNS(
                                        attrNamespaceURI,
                                        attrName
                                    )
                                }
            ...
            function (require, module, exports) {
                ...
                function nanoraf(render, raf) {
                    assert.equal(
                        typeof render,
                        'function',
                        'nanoraf: render should be a function'
                    )
                    assert.ok(
                        typeof raf === 'function' || typeof raf === 'undefined',
                        'nanoraf: raf should be a function or undefined'
                    )
            ...
            function (require, module, exports) {
                ...
                NanoScheduler.prototype.push = function (cb) {
                    assert.equal(
                        typeof cb,
                        'function',
                        'nanoscheduler.push: cb should be type function'
                    )
            ...
            function (require, module, exports) {
                ...
                function nanotiming(name) {
                    assert.equal(
                        typeof name,
                        'string',
                        'nanotiming: name should be type string'
                    )

                    if (nanotiming.disabled) return noop

                    var uuid =
                        (perf.now() * 10000).toFixed() % Number.MAX_SAFE_INTEGER
        ...
        20: [
            function (require, module, exports) {
                 ...
                 */
                module.exports = function removeItems(
                    arr,
                    startIdx,
                    removeCount
                ) {
